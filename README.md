...
1- This program uses **pynput** library to read the keyboard keys *globally*.

2- Parameters are declared using **declare_parameter()** function inherited from *Node* imported from *rclpy.node*.
